...
Future<int?> getWaitingRoomId(int userId) async {
  final url =
      'https://ywhjlgvtjywhacgqtzqh.supabase.co/functions/v1/get_waiting_room_id';
  final headers = {
...
class _WaitingRoomScreenState extends State<WaitingRoomScreen> {
  ...
  void initState() {
    super.initState();
    // Track that the waiting room page was opened
  ...
  Future<void> _initializeLogic() async {
    ...
    if (fetchedWaitingRoomId != null) {
      ...
      // Track waiting room loaded event
  ...
  Future<void> _handleCreateWaitingRoom() async {
    ...
    if (newWaitingRoomId != null) {
      ...
      // Track waiting room creation event
  ...
  Future<void> _handleJoinWaitingRoom() async {
    ...
    if (success) {
      ...
      // Track waiting room joined event
  ...
  Future<void> _handleStartLeague() async {
    ...
    if (success) {
      ...
      // Track league room started event
